...
import 'package:open_hands/app/domain/words_list_data.dart';
...
class WordHomeScreen extends StatefulWidget {
  ...
  @override
  _WordHomeScreenState createState() => _WordHomeScreenState();
}

class _WordHomeScreenState extends State<WordHomeScreen> with TickerProviderStateMixin {
  AnimationController? animationController;
  List<WordData> wordList = WordData.wordList;
                        ...
                        body: Container(
                          ...
                          child: ListView.builder(
                            ...
                            itemBuilder: (BuildContext context, int index) {
                              final int count = wordList.length > 10 ? 10 : wordList.length;
  ...
  Widget getWordViewList() {
    final List<Widget> wordListViews = <Widget>[];
              ...
              child: InkWell(
                ...
                child: Padding(
                  ...
                  child: Icon(FontAwesomeIcons.magnifyingGlass,
                      size: 20, color: AppTheme.buildLightTheme().backgroundColor),
                ),
              ),
            ),
          ),
