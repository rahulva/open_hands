...
class WordsListView extends StatelessWidget {
  const WordsListView({Key? key, this.wordData, this.animationController, this.animation, this.callback})
      : super(key: key);
  ...
  Text attemptText() {
    return Text(
      ' ${wordData!.failedAttempts} Attempts',
      style: TextStyle(fontSize: 14, color: Colors.grey.withOpacity(0.8)),
    );
  }
  ...
  Text distanceText() {
    return Text(
      '${wordData!.dist.toStringAsFixed(1)} km to city',
